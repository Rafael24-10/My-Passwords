...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $actions->update($id, $newdata, $conn);
}
    ...
    <section>
        <div class="login-box">
            ...
            <form autocomplete="off" action="" method="POST">
                ...
                <div class="input-box">
                    <input type="text" name="username" maxlength="15" value="<?php echo $userdata["username"] ?>" required>
                ...
                <div class="actions">
                    ...
                    <div class="delete">
                        <a href="../controller/delete.php" onclick="return confirm('Are you sure you want to delete your account?')" ;>
                            <img src="../public/images/trash.svg">
                        </a>
                        <a href="../controller/delete.php" onclick="return confirm('Are you sure you want to delete your account?')" ;>Delete account</a>
                    </div>
                </div>
            </form>
        </div>
